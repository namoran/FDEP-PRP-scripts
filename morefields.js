...
//UT Label
var aRectutLabel=[];
aRectutLabel[0]= 8.70*inch; //left side of text input
aRectutLabel[2]= aRectutLabel[0]+0.35*inch; // calculate width
aRectutLabel[1]= 8.45*inch; // top of the field
...
//UT no
var aRectut=[];
aRectut[0] = aRectutLabel[2] + 0.5; //left side of text input
...
aRectprgLabel[1]= aRectutLabel[3] -0.5;
...
//Prg
var aRectprg=[];
aRectprg[0] = aRectprgLabel[2] + 0.5; //left side of text input
...
aRectscrLabel[1]= aRectprgLabel[3] - 0.5;
...
var aRectscr=[];
aRectscr[0] = aRectscrLabel[2] + 0.5; //left side of text input
