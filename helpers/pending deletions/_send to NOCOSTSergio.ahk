...
Run %comspec% /C ""C:\Program Files (x86)\Microsoft Office\root\Office16\OUTLOOK.EXE"/c ipm.note /m "prp.nocostchange@dep.state.fl.us &cc=didier.camacho@miamidade.gov`; James.Fletcher@dep.state.fl.us &subject=%FACID% - %refno% - Date Extension Only" /a "%LongPath%"",,Hide
