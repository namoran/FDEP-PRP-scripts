...
#IfWinActive SmarTerm 

WinWaitActive, SmarTerm
...
WinActivate, SmarTerm 
Send, Status Rev{tab}Petroleum Cleanup Site Inspection{tab}D{tab}%MyDateTime%{tab}{backspace 2}1{tab}%MyDateTime%{tab}y{tab}EDOUAS {tab}UT
Return
;------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
F1::
if WinExist("HELP") 
...
Gui, Add, Edit, x101 y24 w140 h20 -Multi Limit40 vDesc, %Desc%
...
Gui, Add, ComboBox, x521 y24 w60 Limit12 vUSER, BAMMAZ|CAMACD|HERMAC|RODRIRO|CASTRM|KATOCV|E317181|E317042|E317305|E322925
; Generated using SmartGUI Creator 4.0
